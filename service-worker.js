const CACHE_NAME = 'point-shot-v6-stability-optimization'; // pinch zoom 안정화 + saveState 저장 큐 + 야외용 라이트 UI 적용 버전.
...
const VENDOR_ASSETS = [
  ...
  'https://cdn.jsdelivr.net/npm/docx@8.0.4/build/index.js',
